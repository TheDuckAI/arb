  ...
  return (
    <Box bg="#F9FAFC">
      ...
      <Container maxW="container.xl" py={8}>
        ...
        <Box p={4} mb={4} borderWidth="1px" borderRadius="md" bg="gray.50">
            <Code>https://advanced-reasoning-benchmark.netlify.app/api/lib/math/{&quot;answer-type&quot;}/</Code>
        </Box>
        <Text mb={4}>
        ...
        <Box p={4} mb={4} borderWidth="1px" borderRadius="md" bg="gray.50">
            <Code>https://advanced-reasoning-benchmark.netlify.app/api/lib/mcatReading/{&quot;split&quot;}/</Code>
        </Box>
        <Text mb={4}>
        ...
        <Box p={4} mb={4} borderWidth="1px" borderRadius="md" bg="gray.50">
            <Code>import requests 
            <br/>
            response = requests.get(&quot;https://advanced-reasoning-benchmark.netlify.app/api/lib/mcatReading/test&quot;)
            <br/>
            data = response.json()</Code>
        </Box> 
    </Container>
